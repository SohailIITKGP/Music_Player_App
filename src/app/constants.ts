...
export const playListData: Track[] = [
  {
    ...
    url: Asset.fromModule(require("../assets/audio/one.mp3")).uri,
  },
  {
    id: "2",
    ...
    url: Asset.fromModule(require("../assets/audio/two.mp3")).uri,
  },
  {
    id: "3",
    title: "Kesariya",
    ...
    url: Asset.fromModule(require("../assets/audio/three.mp3")).uri,
  },
  {
    id: "4",
    title: "Title Track",
    ...
    url: Asset.fromModule(require("../assets/audio/four.mp3")).uri,
  },
  {
    id: "5",
    title: "Besharam Rang",
    ...
    url: Asset.fromModule(require("../assets/audio/five.mp3")).uri,
  },
];
